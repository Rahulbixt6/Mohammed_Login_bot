...
SUBSCRIPTION = os.environ.get('SUBSCRIPTION', 'https://graph.org/file/5da2239f78e2467f1df9c-91c72d386238b07ee5.jpg')
FREE_LIMIT_SIZE = 2 * 1024 * 1024 * 1024
FREE_LIMIT_DAILY = 10
UPI_ID = os.environ.get("UPI_ID", "9963812392@axl")
QR_CODE = os.environ.get("QR_CODE", "https://graph.org/file/ae46dc4d45d9d8aa4c651-eb56d69273d3eaedaf.jpg")
REACTIONS = [
    "ðŸ‘", "â¤ï¸", "ðŸ”¥", "ðŸ¥°", "ðŸ‘", "ðŸ˜", "ðŸ¤”", "ðŸ¤¯", "ðŸ˜±", "ðŸ¤¬",
    "ðŸ˜¢", "ðŸŽ‰", "ðŸ¤©", "ðŸ¤®", "ðŸ’©", "ðŸ™", "ðŸ‘Œ", "ðŸ•Š", "ðŸ¤¡", "ðŸ¥±",
    "ðŸ¥´", "ðŸ˜", "ðŸ³", "â¤ï¸â€ðŸ”¥", "ðŸŒš", "ðŸŒ­", "ðŸ’¯", "ðŸ¤£", "âš¡", "ðŸŒ",
    "ðŸ†", "ðŸ’”", "ðŸ¤¨", "ðŸ˜", "ðŸ“", "ðŸ¾", "ðŸ’‹", "ðŸ–•", "ðŸ˜ˆ", "ðŸ˜´",
    "ðŸ˜­", "ðŸ¤“", "ðŸ‘»", "ðŸ‘¨â€ðŸ’»", "ðŸ‘€", "ðŸŽƒ", "ðŸ™ˆ", "ðŸ˜‡", "ðŸ˜¨", "ðŸ¤",
    "âœ", "ðŸ¤—", "ðŸ«¡", "ðŸŽ…", "ðŸŽ„", "â˜ƒ", "ðŸ’…", "ðŸ¤ª", "ðŸ—¿", "ðŸ†’",
    "ðŸ’˜", "ðŸ™‰", "ðŸ¦„", "ðŸ˜˜", "ðŸ’Š", "ðŸ™Š", "ðŸ˜Ž", "ðŸ‘¾", "ðŸ¤·â€â™‚ï¸", "ðŸ¤·â€â™€ï¸",
    "ðŸ˜¡"
]

dev_text = "ðŸ‘¨â€ðŸ’» Mind Behind This Bot:\nâ€¢ @Mr_Mohammed_29\nâ€¢ @Aero_Unity"
channels_text = "ðŸ“¢ Channel: @Aero_Unity"
...
class script(object):
    ...
    START_TXT = """<b>ðŸ‘‹ Hello {},</b>
<b>ðŸ¤– I am <a href=https://t.me/{}>{}</a></b>
<i>Your Professional AU Restricted Content Saver Bot.</i>
<blockquote><b>ðŸš€ System Status: ðŸŸ¢ Online</b>
<b>âš¡ Performance: 10x High-Speed Processing</b>
<b>ðŸ” Security: End-to-End Encrypted</b>
<b>ðŸ“Š Uptime: 99.9% Guaranteed</b></blockquote>
<b>ðŸ‘‡ Select an Option Below to Get Started:</b>
"""
    HELP_TXT = """<b>ðŸ“š Comprehensive Help & User Guide</b>
...
<blockquote><b>ðŸ›‘ Free User Limitations:</b></blockquote>
â€¢ <b>Daily Quota:</b> 10 Files / 24 Hours
â€¢ <b>File Size Cap:</b> 2GB Maximum
<blockquote><b>ðŸ’Ž Premium Membership Benefits:</b></blockquote>
â€¢ Unlimited Downloads & No Restrictions.
â€¢ Priority Support & Advanced Features.
"""
    ABOUT_TXT = """<b>â„¹ï¸ About This Bot</b>
<blockquote><b>â•­â”€â”€â”€â”€[ ðŸ§© Technical Stack ]â”€â”€â”€â”€âŸ</b>
<b>â”œâŸ ðŸ¤– Bot Name : <a href=https://t.me/AU_Save_Restricted_Content_bot>AU Saver Bot</a></b>
<b>â”œâŸ ðŸ‘¨â€ðŸ’» Developer : <a href=https://t.me/Mr_Mohammed_29>Mohammed</a></b>
<b>â”œâŸ ðŸ“š Library : <a href='https://docs.pyrogram.org/'>Pyrogram Async</a></b>
<b>â”œâŸ ðŸ Language : <a href='https://www.python.org/'>Python 3.11+</a></b>
<b>â”œâŸ ðŸ—„ Database : <a href='https://www.mongodb.com/'>MongoDB Atlas Cluster</a></b>
<b>â”œâŸ ðŸ“¡ Hosting : Render</b>
<b>â•°â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€âŸ</b></blockquote>
"""
    PREMIUM_TEXT = """<b>ðŸ’Ž Premium Membership Plans</b>
<b>Unlock Unlimited Access & Advanced Features!</b>
<blockquote><b>âœ¨ Key Benefits:</b>
<b>â™¾ï¸ Unlimited Daily Downloads</b>
<b>ðŸ“‚ Support for 4GB+ File Sizes</b>
<b>âš¡ Instant Processing (Zero Delay)</b>
<b>ðŸ–¼ Customizable Thumbnails</b>
<b>ðŸ“ Personalized Captions</b>
<b>ðŸ›‚ 24/7 Priority Support</b></blockquote>
<blockquote><b>ðŸ’³ Pricing Options:</b></blockquote>
...
<blockquote><b>ðŸ‘‡ Secure Payment:</b></blockquote>
<b>ðŸ’¸ UPI ID:</b> <code>{}</code>
<b>ðŸ“¸ QR Code:</b> <a href='{}'>Scan to Pay</a>
...
<b>ðŸš€ Speed:</b> <code>{speed}/s</code>
<b>ðŸ’¾ Size:</b> <code>{current} of {total}</code>
<b>â± Elapsed:</b> <code>{elapsed}</code>
<b>â³ ETA:</b> <code>{eta}</code>
</blockquote>
"""
    CAPTION = """<b><a href="https://t.me/Anime_UpdatesAU"></a></b>\n\n<b>âšœï¸ Powered By : <a href="https://t.me/Anime_UpdatesAU">Anime Updates âš¡ï¸</a></b>"""
    LIMIT_REACHED = """<b>ðŸš« Daily Limit Exceeded</b>
<b>Your 10 free saves for today have been used.</b>
<i>Quota resets automatically after 24 hours from first download.</i>
<blockquote><b>ðŸ”“ Upgrade to Premium for Unlimited Access!</b></blockquote>
...
<blockquote><b>ðŸ”“ Upgrade to Premium</b></blockquote>
...
async def send_start(client: Client, message: Message):
    ...
    try:
        ...
        pass
    apis = ["https://graph.org/file/5da2239f78e2467f1df9c-91c72d386238b07ee5.jpg", "https://nekos.life/api/v2/img/waifu"]
...
async def send_help(client: Client, message: Message):
    buttons = [[InlineKeyboardButton("âŒ Close Menu", callback_data="close_btn")]]
...
async def send_plan(client: Client, message: Message):
    buttons = [
        ...
        [InlineKeyboardButton("âŒ Close Menu", callback_data="close_btn")]
    ]
    await client.send_photo(
        chat_id=message.chat.id,
        photo=SUBSCRIPTION,
...
async def send_cancel(client: Client, message: Message):
    ...
    await message.reply_text("âŒ Batch Process Cancelled Successfully.")
async def settings_panel(client, callback_query):
    ...
    badge = "ðŸ’Ž Premium Member" if is_premium else "ðŸ‘¤ Standard User"

    buttons = InlineKeyboardMarkup([
        [InlineKeyboardButton("ðŸ“œ Command List", callback_data="cmd_list_btn")],
        [InlineKeyboardButton("ðŸ“Š Usage Stats", callback_data="user_stats_btn")],
        [InlineKeyboardButton("ðŸ—‘ Dump Chat Settings", callback_data="dump_chat_btn")],
        [InlineKeyboardButton("ðŸ–¼ Manage Thumbnail", callback_data="thumb_btn")],
        [InlineKeyboardButton("ðŸ“ Edit Caption", callback_data="caption_btn")],
...
async def save(client: Client, message: Message):
    if "https://t.me/" in message.text:
        ...
        if is_limit_reached:
            btn = InlineKeyboardMarkup([[InlineKeyboardButton("ðŸ’Ž Upgrade to Premium", callback_data="buy_premium")]])
...
async def handle_restricted_content(client: Client, acc, message: Message, chat_target, msgid):
    ...
    try:
        ...
        if batch_temp.IS_BATCH.get(message.from_user.id) or "Cancelled" in str(e):
            ...
            return await smsg.edit("âŒ **Task Cancelled**")
...
async def button_callbacks(client: Client, callback_query: CallbackQuery):
   ...
   # --- DEVELOPER INFO --- #
    if data == "dev_info":
        ...
        bot = await client.get_me()
        apis = ["https://graph.org/file/d724c853cc83da444c7b5-821df256fdead2c9f1.jpg", "https://graph.org/file/0e77ba48a8b7a3b09296f-362372bee0d84fd217.jpg"]
        api_url = random.choice(apis)
        try:
            response = requests.get(api_url)
            response.raise_for_status()
